...
namespace SyncfusionThemeRegistrator;
...
public static class SfThemeRegistrator
{
    ...
    // private static readonly ILogger s_log = LoggerCreator.CreateLogger(nameof(SfThemeRegistrator));
    ...
    public static void SetTheme(DependencyObject dependencyObject)
    {
        ...
        {
            Console.WriteLine(e);
            // s_log.LogInformation(e, "{Message} DependencyObject: {DependencyObject}", e.Message,
