...
BEGIN
	...
	CREATE TABLE #Pricing_TvMessageTempTable (Id INT, BlockPosition TINYINT, Footage SMALLINT, Rating DECIMAL(10,4), SponsoredProgrammeId INT, IsSponsoredProgrammeUserDefined BIT,
		...
		BlockId INT, BlockEnd DATETIME, BlockIdent VARCHAR(18), BlockRating DECIMAL(10,4), BlockStart DATETIME, BlockUnits TINYINT, BlockCode VARCHAR(20), ProgrammeAfter NVARCHAR(200), ProgrammeTypeIdAfter SMALLINT, ProgrammeBefore NVARCHAR(100), ProgrammeTypeIdBefore SMALLINT, ProgrammeIn NVARCHAR(200), ProgrammeTypeIdIn SMALLINT, BroadcastingDescriptionIdIn int)
	...
	INSERT INTO #Pricing_TvMessageTempTable (Id, BlockPosition, Footage, Rating, SponsoredProgrammeId, IsSponsoredProgrammeUserDefined,
		...
		BlockId, BlockEnd, BlockIdent, BlockRating, BlockStart, BlockUnits, BlockCode, ProgrammeAfter, ProgrammeTypeIdAfter, ProgrammeBefore, ProgrammeTypeIdBefore, ProgrammeIn, ProgrammeTypeIdIn, BroadcastingDescriptionIdIn)
	...
	SELECT tmm.Id, tmm.BlockPosition, tmm.Footage, tmm.Rating, tmm.SponsoredProgrammeId, tmm.IsSponsoredProgrammeUserDefined,
		...
		pb.Id,pb.BlockEnd,pb.BlockIdent,pb.BlockRating,pb.BlockStart,pb.BlockUnits,pb.BlockCode,prAfter.Name,prAfter.PrgTypeId,prBefore.Name,prBefore.PrgTypeId,prIn.Name,prIn.PrgTypeId,pb.BroadcastingDescriptionIdIn
	...
	SELECT 
		...
		tvmsg.ProgrammeBefore AS 'ProgrammeBlock.ProgrammeBefore',
