...
namespace Syncfusion.Themes.Office2019Colorful_Kite.WPF
{
    /// <exclude/>
    public class Office2019Colorful_KiteSkinHelper : SkinHelper
    {
        ...
        {
            string rootStylePath = "/Syncfusion.Themes.Office2019Colorful_Kite.WPF;component/";
    ...
    /// </summary>
    public class Office2019Colorful_KiteThemeSettings: IThemeSetting
    {
        /// <summary>
        /// Constructor to create an instance of Office2019Colorful_KiteThemeSettings.
        /// </summary>
        public Office2019Colorful_KiteThemeSettings()
        {
        ...
        /// <para>The default value is <see cref="Office2019Palette.Default"/>.</para>
        ...
        /// </listheader>
		/// <item>
		/// <term><see cref="Office2019Palette.Default"/></term>
		/// <description>The Default palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.Red"/></term>
		/// <description>The Red palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.Blue"/></term>
		/// <description>The Blue palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.Green"/></term>
		/// <description>The Green palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.RedOrange"/></term>
		/// <description>The RedOrange palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.Violet"/></term>
		/// <description>The Violet palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.DeepGreen"/></term>
		/// <description>The DeepGreen palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.DeepViolet"/></term>
		/// <description>The DeepViolet palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.RedBrown"/></term>
		/// <description>The RedBrown palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.GreenCyan"/></term>
		/// <description>The GreenCyan palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.DeepGreenCyan"/></term>
		/// <description>The DeepGreenCyan palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.LightViolet"/></term>
		/// <description>The LightViolet palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.MarinerBlue"/></term>
		/// <description>The MarinerBlue palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.DeepBlue"/></term>
		/// <description>The DeepBlue palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Office2019Palette.LightBlue"/></term>
        ...
        /// <code language="C#">
        /// <![CDATA[
        /// Office2019Colorful_KiteThemeSettings themeSettings = new Office2019Colorful_KiteThemeSettings();
		/// themeSettings.Palette = Office2019Palette.Red;
        /// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", themeSettings);
        /// ]]>
        /// </code>
        /// </example>
        /// <remarks>
        ...
        /// </remarks>
        public Office2019Palette Palette { get; set; }
        #endregion
		...
		/// <code language="C#">
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.HeaderFontSize = 16;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.SubHeaderFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.TitleFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.SubTitleFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.BodyFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.Body AltFontSize = 10;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.FontFamily = new FontFamily("Callibri");
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.PrimaryBackground = Brushes.Red;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		public Brush PrimaryBackground
		{
			...
			set
			{
				...
				PrimaryColorDark3 = ThemeSettingsHelper.GetDerivationColor(value, 0.21, 0);
				PrimaryColorDark2 = ThemeSettingsHelper.GetDerivationColor(value, 0.14, 0);
				PrimaryColorDark1 = ThemeSettingsHelper.GetDerivationColor(value, 0.07, 0);
				PrimaryColorLight1 = ThemeSettingsHelper.GetDerivationColor(value, -0.13, 0);
				PrimaryColorLight2 = ThemeSettingsHelper.GetDerivationColor(value, -0.26, 0);
				PrimaryColorLight3 = ThemeSettingsHelper.GetDerivationColor(value, -0.39, 0);
				PrimaryColorLight4 = ThemeSettingsHelper.GetDerivationColor(value, -0.5, 0);
		...
		/// <![CDATA[
		/// Office2019Colorful_KiteThemeSettings office2019Colorful_KiteThemeSettings = new Office2019Colorful_KiteThemeSettings();
		/// office2019Colorful_KiteThemeSettings.PrimaryForeground = Brushes.AntiqueWhite;
		/// SfSkinManager.RegisterThemeSettings("Office2019Colorful_Kite", office2019Colorful_KiteThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
