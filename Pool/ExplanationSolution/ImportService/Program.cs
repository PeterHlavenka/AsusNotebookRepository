...
async Task SendMessage(string country, string environment, DateTime importDateTime, string[] adwDataIds)
{
...
async Task SendMultipleMessages()
{
    ...
    // CZ
    await SendMessage("CZ", "Production", dateTime, [AdwDataIds.DataCzCsProTrend2, AdwDataIds.DataCzAdCross]);
