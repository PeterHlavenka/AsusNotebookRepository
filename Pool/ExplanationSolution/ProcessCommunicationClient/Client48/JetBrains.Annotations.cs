...
namespace JetBrains.Annotations
{
    ...
    /// <summary>
    /// Označuje konstruktor, který je potřeba pro serializaci, přesto že jinak se může zdát zbytečný.
    /// </summary>
    [AttributeUsage(AttributeTargets.Constructor | AttributeTargets.Method | AttributeTargets.Class)]
    [MeansImplicitUse]
    public class ForSerialization : Attribute
    {
    }

    /// <summary>
    /// Oznacuje metody a property, ktere jsou volany pres Caliburn
    /// </summary>
    [AttributeUsage(AttributeTargets.All)]
    [MeansImplicitUse]
    public class ForCaliburn : Attribute
    {
    }

    /// <summary>
    /// Tímhle attributem si označuju věci, který byli nahrazený něčím lepším/jednodušším, a jakmile bude čas, 
    /// tak půjdou pryč nebo jinam.
    /// 
    /// Robo
    /// 
    /// </summary>
    [AttributeUsage(AttributeTargets.All)]
    public class OldAPI : Attribute
    {
        private readonly string m_comment;

        public OldAPI(string comment = (string)null)
        {
            m_comment = comment;
        }
