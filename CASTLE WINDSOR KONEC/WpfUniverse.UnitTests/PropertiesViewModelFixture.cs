...
namespace WpfUniverse.UnitTests
{
    ...
    public class PropertiesViewModelFixture
    {
        ...
        public void PropertiesTest()
        {
            ...
            var observableCollection = new ObservableCollection<VlastnostDataContract>()
            {
            ...
            var viewModel = new PropertiesViewModel(planetSelectorMock.Object, propertiesManagerMock.Object, planetPropertiesDaoMock.Object);
            ...
            observableCollection[0].IsChecked = false;

            Assert.IsEmpty(selectedPlanet.Properties);
            Assert.IsTrue(selectedPlanet.Properties.Count == 0 );
        }
    }
}
