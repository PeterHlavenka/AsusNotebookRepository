...
namespace WpfUniverse.ViewModels
{
    public class PropertiesViewModel : ViewModelBase, IEventRegistrator
    {
        ...
        public PropertiesViewModel(IPlanetSelector selector, IPropertiesManager vlastnostManager,
            IVlastnostiPlanetDao vlastnostiPlanetDao)
        {
        ...
        private void CheckForCheckedProperties()
        {
            ...
            foreach (var vdc in ListOfVlastnosts)
            {
                ...
                foreach (var vl in m_selectedPlanet.Properties)
                    if (vdc.Nazev == vl.Nazev
                    ) // Pokud se nazev nektere vlastnosti v seznamu vsech vlastnosti shoduje s nazvem vlastnosti v seznamu planety
        ...
        /// <summary>
        ///     Odskrtavani checkboxu . Tahle metoda zachytava event ktery vyhazuje trida VlastnostDataContract kdyz se ji zmeni
        ///     nejaka vlastnost. Tady IsChecked.
