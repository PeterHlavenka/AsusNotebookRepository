...
namespace WpfUniverse.Entities
{
    ...
    {
        public UniverseDataModel(DataProviderBase dataProvider, string connectionString) : base(dataProvider,
            connectionString)
        {
        }

        public UniverseDataModel(DataProviderBase dataProvider, IDbConnection connection) : base(dataProvider,
            connection)
        {
        }

        public UniverseDataModel(DataProviderBase dataProvider, IDbTransaction transaction) : base(dataProvider,
            transaction)
        {
        }
