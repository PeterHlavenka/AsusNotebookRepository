...
namespace Syncfusion.Themes.Windows11TealDarkTheme.WPF
{
    /// <exclude/>
    public class Windows11TealDarkThemeSkinHelper : SkinHelper
    {
        ...
        {
            string rootStylePath = "/Syncfusion.Themes.Windows11TealDarkTheme.WPF;component/";
			...
			switch (type)
			{
				...
				case "Syncfusion.UI.Xaml.Kanban.PlaceholderStyle":
					...
					break;
				case "Syncfusion.UI.Xaml.Kanban.KanbanCardItem":
					styles.Add(rootStylePath + "SfKanban/SfKanban.xaml");
					break;
    ...
    /// </summary>
    public class Windows11TealDarkThemeThemeSettings: IThemeSetting
    {
        /// <summary>
        /// Constructor to create an instance of Windows11TealDarkThemeThemeSettings.
        /// </summary>
        public Windows11TealDarkThemeThemeSettings()
        {
        ...
        /// <para>The default value is <see cref="Windows11Palette.Default"/>.</para>
        ...
        /// </listheader>
		/// <item>
		/// <term><see cref="Windows11Palette.Default"/></term>
		/// <description>The Default palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Windows11Palette.PurpleShadowDark"/></term>
		/// <description>The PurpleShadowDark palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Windows11Palette.VioletRed"/></term>
		/// <description>The VioletRed palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Windows11Palette.PlumbLight"/></term>
		/// <description>The PlumbLight palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Windows11Palette.MintLight"/></term>
		/// <description>The MintLight palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Windows11Palette.YellowGold"/></term>
		/// <description>The YellowGold palette primary colors will be applied for specific theme.</description>
		/// </item>
		/// <item>
		/// <term><see cref="Windows11Palette.SteelBlue"/></term>
		/// <description>The SteelBlue palette primary colors will be applied for specific theme.</description>
		/// </item>
        /// </list>
        /// </value>
        /// <example>
        /// <code language="C#">
        /// <![CDATA[
        /// Windows11TealDarkThemeThemeSettings themeSettings = new Windows11TealDarkThemeThemeSettings();
		/// themeSettings.Palette = Windows11Palette.PurpleShadowDark;
        /// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", themeSettings);
        /// ]]>
        /// </code>
        /// </example>
        /// <remarks>
		...
		/// <code language="C#">
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.HeaderFontSize = 16;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.SubHeaderFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.TitleFontSize = 14;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.SubTitleFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.BodyFontSize = 12;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.Body AltFontSize = 10;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.FontFamily = new FontFamily("Callibri");
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.PrimaryBackground = Brushes.Red;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		public Brush PrimaryBackground
		{
			...
			set
			{
				...
				PrimaryBackgroundGradient = value;
				...
				PrimaryColorLight2 = ThemeSettingsHelper.GetDerivationColor(value, -0.2, 0);
				PrimaryColorLight3 = ThemeSettingsHelper.GetDerivationColor(value, -0.25, 0);
				BorderAlt2Gradient = value;
				PrimaryBackgroundOpacity1 = ThemeSettingsHelper.GetDerivationColor(value, 0, 0.9);
				PrimaryBackgroundOpacity2 = ThemeSettingsHelper.GetDerivationColor(value, 0, 0.8);
		...
		/// <![CDATA[
		/// Windows11TealDarkThemeThemeSettings windows11TealDarkThemeThemeSettings = new Windows11TealDarkThemeThemeSettings();
		/// windows11TealDarkThemeThemeSettings.PrimaryForeground = Brushes.AntiqueWhite;
		/// SfSkinManager.RegisterThemeSettings("Windows11TealDarkTheme", windows11TealDarkThemeThemeSettings);
		/// ]]>
		/// </code>
		/// </example>
		public Brush PrimaryForeground
		{
			...
			set
			{
				...
				PrimaryForegroundDisabled = ThemeSettingsHelper.GetDerivationColor(value, 0, 0.53);
				PrimaryForegroundOpacity1 = ThemeSettingsHelper.GetDerivationColor(value, 0, 0.53);
			}
		}
