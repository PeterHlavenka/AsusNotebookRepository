...
namespace WpfUniverse.ViewModels
{
    public class PlanetsViewModel : ViewModelBase, IPlanetSelector
    {
        ...
        public PlanetsViewModel(IDaoSource daoSource, IPlanetDao planetDao, IVlastnostDao vlastnostDao, IVlastnostiPlanetDao vlastnostiPlanetDao, IGalaxySelector selector, IPropertiesManager vlastnostManager)
        {
        ...
        private void OnGalaxyChanged(object sender, GalaxyDataContract galaxy)
        {
            ...
            {
                galaxy.Planets = m_planetDao.LoadPlanetsBasedOnGalaxyId(m_selectedGalaxy.Id).Select(PlanetDataContract.Create).ToList();
            }
        ...
        {
            var pdw = new PlanetaDialogWindow();
        ...
        public void DoEditProperties()
        {
            ...
            var apvm = new EditPropertyViewModel(m_vlastnostDao, m_vlastnostiPlanetDao, m_transactionManager, m_eventRegistrator, this, m_vlastnostManager);
