...
{
    public class PlanetDao : EntityIdentityKeyDaoBase<Planet, UniverseDataModel, int, Planet>, IPlanetDao
    {
        ...
        public IEnumerable<Planet> LoadPlanetsBasedOnGalaxyId(int id)
        {
            using (var model = CreateDbContext())
            {
                var query = (from pl in model.Planeta                                                               // Vybirame z tabulky Planet
                ...
                var result = new List<Planet>();                                                                // Nove uloziste
                ...
                {
                    var planet = dato.First().Planet;                                                                      // Planet bude prvni polozka
    ...
    public interface IPlanetDao : ISimpleDao<Planet, int>
    {
        IEnumerable<Planet> LoadPlanetsBasedOnGalaxyId(int id);
    }
}
